...
public interface MobileService {
    ...
    List<MobilePhoneDto> getMobilePhoneDtoByBrandName(String brandName);
    int getMobilePhoneCount(double cost);
    List<MobilePhone> getByProcessor(String processor);
    List<MobilePhone> getByColor(String color);
    int getMobilePhonesCount();
